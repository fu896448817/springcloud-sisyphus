package com.prometheus.sisyphus.redis.redis;


import com.fasterxml.jackson.annotation.JsonInclude;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.prometheus.sisyphus.redis.listener.RedisMessageListener;
...
//    @Bean
    ...
    RedisMessageListenerContainer keyExpirationListenerContainer(RedisConnectionFactory connectionFactory) {
        ...
        listenerContainer.addMessageListener(messageListener(), new PatternTopic("sisyphus.*__:expired"));
