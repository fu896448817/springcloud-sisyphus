package com.prometheus.sisyphus.uaa.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.prometheus.sisyphus.uaa.entity.UaaUser;
import com.prometheus.sisyphus.uaa.util.Constants;
...
public class JWTLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res) throws AuthenticationException {
        try {
            UaaUser user = new ObjectMapper().readValue(req.getInputStream(), UaaUser.class);
